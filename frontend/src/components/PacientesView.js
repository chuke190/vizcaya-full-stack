  ...
  return (
    <div className="viewbody">
      ...
      <div className="pacientes-view">
        ...
        <p className="patient-count">Número de Pacientes Procesados: {filteredPacientes.length}</p>
            ...
            {filteredPacientes.length ? (
              filteredPacientes.map((paciente) => (
                <tr key={paciente.id}>
                  ...
                  <td>
                    <button className="btn-details" onClick={() => handleOpenModal(paciente)}>
                      Ver Detalles
                    </button>
                  </td>
                </tr>
        ...
        {selectedPaciente && (
          <HistorialClinicoModal paciente={selectedPaciente} onClose={handleCloseModal} />
        )}
      </div>
    </div>
  );
