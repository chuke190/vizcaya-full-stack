...
const AgregarPaciente = ({ setPacientesData }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await fetch('http://localhost/sisDenatal/backend2/public/index.php?action=addpaciente', {
            method: 'POST',
            headers: {
                    ...
                    <div className="form-columns">
                        <div className="left-column">
                            ...
                            <div className="form-group">
                                ...
                                {pacienteData.photo && <img src={URL.createObjectURL(pacienteData.photo)} alt="Foto" className="user-photo" />}
                            </div>
                        </div>
